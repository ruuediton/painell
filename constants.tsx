...
export const Icons = {
  ...
  Withdrawals: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 12H4" /><path d="m10 18-6-6 6-6" /></svg>
  ),
  Bonus: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6" /><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18" /><path d="M4 22h16" /><path d="M10 14.66V17c0 .55-.45 1-1 1H7c-.55 0-1-.45-1-1v-2.34c0-.28.11-.54.31-.74l3.52-3.52A1.94 1.94 0 0 1 12 10.12V9c0-1.1.9-2 2-2s2 .9 2 2v1.12c0 .28-.11.54-.31.74l-3.52 3.52c-.2.2-.31.46-.31.74z" /></svg>
  ),
  Logs: () => (
  ...
  Database: () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3c-4.97 0-9 1.79-9 4s4.03 4 9 4 9-1.79 9-4-4.03-4-9-4Z" /><path d="M19 8.95c0 2.21-3.13 4-7 4s-7-1.79-7-4" /><path d="M5 14c0 2.21 3.13 4 7 4s7-1.79 7-4" /><path d="M5 19c0 2.21 3.13 4 7 4s7-1.79 7-4" /><path d="M3 7v12" /><path d="M21 7v12" /></svg>
  ),
  History: () => (
